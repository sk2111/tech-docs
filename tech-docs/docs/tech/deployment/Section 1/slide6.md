...
This is the natural evolution that any dev team go through.
...
The team now faces problems, like docker containers crashed, VM Crashed &
affected the app availability.

![Docker Scale 3](./assets/docker_scale_3.png)

1. They need high availability & they want failover when a container crashes
2. They want multiple VMs/nodes to cope with increased traffic & availability

Docker Compose cannot do this. Docker Swarm acts as the live saver.
