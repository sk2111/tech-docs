...
:::important
    1. For enhanced security, consider using additional encryption mechanisms or tools like K8's Encryption at Rest or  external secret management solutions.
    ...
    5. With nattive K8's secrets are not encrypted by default.
:::
...
2. Lets first create a private repo in docker hub & push a sample private docker image.
...
7. Lets create a docker hub and create a PAT (Personal Access Token) for authentication.
...
1. Secrets can be created using yaml files.
